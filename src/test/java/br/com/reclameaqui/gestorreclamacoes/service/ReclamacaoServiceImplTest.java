...
public class ReclamacaoServiceImplTest {
  ...
  public void testFailIllegalArgumentsRecuperarReclamacoes() {
    Page<Reclamacao> result = reclamacaoServiceImpl.recuperarReclamacoes(Integer.valueOf(0), Integer.valueOf(0));
  }


  @Test(expected = NaoEncontradoException.class)
  public void testFailRecuperarReclamacaoPorId() throws Exception {
    Reclamacao result = reclamacaoServiceImpl.recuperarReclamacaoPorId("idReclamacao");
    Assert.assertEquals(new Reclamacao("id", "titulo", "descricao", LocalDate.of(2021, Month.MAY, 18), new Localidade("id", "pais", "estado", "cidade"), new Empresa("id", "fantasia", "cnpj")), result);
    verify(reclamacaoRepository, times(1)).findById(anyString());
  }

  @Test
  public void testRecuperarReclamacaoPorId() throws Exception {
    when(reclamacaoRepository.findById(anyString())).thenReturn(java.util.Optional.of(new Reclamacao()));
    Reclamacao result = reclamacaoServiceImpl.recuperarReclamacaoPorId("idReclamacao");
    Assert.assertEquals(new Reclamacao(), result);
  ...
  public void testFailRecuperarReclamacaoPorData() throws Exception {
    ...
    List<Reclamacao> result = reclamacaoServiceImpl.recuperarReclamacaoPorData(LocalDate.of(2021, Month.MAY, 18), LocalDate.of(2021, Month.MAY, 18));
  ...
  public void testFailDataFimMenorRecuperarReclamacaoPorData() throws Exception {
    when(reclamacaoRepository.findReclamacaoByDataBetween(any(), any())).thenReturn(Arrays.<Reclamacao>asList(new Reclamacao("id", "titulo", "descricao", LocalDate.of(2021, Month.MAY, 18), new Localidade("id", "pais", "estado", "cidade"), new Empresa("id", "fantasia", "cnpj"))));

    List<Reclamacao> result = reclamacaoServiceImpl.recuperarReclamacaoPorData(LocalDate.of(2021, Month.MAY, 18), LocalDate.of(2021, Month.MAY, 17));
    Assert.assertEquals(Arrays.<Reclamacao>asList(new Reclamacao("id", "titulo", "descricao", LocalDate.of(2021, Month.MAY, 18), new Localidade("id", "pais", "estado", "cidade"), new Empresa("id", "fantasia", "cnpj"))), result);
  }
  ...
  public void testRecuperarReclamacaoPorData() throws Exception {
    ...
    List<Reclamacao> result = reclamacaoServiceImpl.recuperarReclamacaoPorData(LocalDate.of(2021, Month.MAY, 18), LocalDate.of(2021, Month.MAY, 18));
    Assert.assertEquals(Arrays.asList(new Reclamacao("id", "titulo", "descricao", LocalDate.of(2021, Month.MAY, 18), new Localidade("id", "pais", "estado", "cidade"), new Empresa("id", "fantasia", "cnpj"))), result);
  }

  @Test
  public void testRecuperarReclamacaoPorEmpresa() throws Exception {
    when(reclamacaoRepository.findReclamacaoByEmpresaIsIn(any())).thenReturn(Arrays.<Reclamacao>asList(new Reclamacao("id", "titulo", "descricao", LocalDate.of(2021, Month.MAY, 18), new Localidade("id", "pais", "estado", "cidade"), new Empresa("id", "fantasia", "cnpj"))));
    when(reclamacaoRepositoryTemplate.recuperarReclamacoesPorEmpresa(any())).thenReturn(Arrays.<String>asList("String"));

    List<Reclamacao> result = reclamacaoServiceImpl.recuperarReclamacaoPorEmpresa("nomeEmpresa", "cnpjEmpresa");
    Assert.assertEquals(Arrays.<Reclamacao>asList(new Reclamacao("id", "titulo", "descricao", LocalDate.of(2021, Month.MAY, 18), new Localidade("id", "pais", "estado", "cidade"), new Empresa("id", "fantasia", "cnpj"))), result);
  }

  @Test
  public void testRecuperarReclamacaoPorLocalidade() throws Exception {
    when(reclamacaoRepository.findReclamacaosByLocalidadeIsIn(any())).thenReturn(Arrays.<Reclamacao>asList(new Reclamacao("id", "titulo", "descricao", LocalDate.of(2021, Month.MAY, 18), new Localidade("id", "pais", "estado", "cidade"), new Empresa("id", "fantasia", "cnpj"))));
    when(localidadeService.recuperarIdsLocalidade(any())).thenReturn(Arrays.<String>asList("String"));

    List<Reclamacao> result = reclamacaoServiceImpl.recuperarReclamacaoPorLocalidade("pais", "estado", "cidade");
    Assert.assertEquals(Arrays.<Reclamacao>asList(new Reclamacao("id", "titulo", "descricao", LocalDate.of(2021, Month.MAY, 18), new Localidade("id", "pais", "estado", "cidade"), new Empresa("id", "fantasia", "cnpj"))), result);
  }
